...
void VolumetricClouds::draw()
{
	...
	cloudsShader.setVec3("loghtColor", s->lightColor);
	...
	cloudsShader.setVec3("shyColorBottom", model->sky->skyColorBottom);
	...
	if (model->postProcess)
	{
		...
		cloudsPPShader.setBool("lightDotCameraFront", lightDotCameraFront);
